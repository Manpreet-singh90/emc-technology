...
import CERTIFICATES1 from '@/assets/certificates/certificates1.jpg'
import CERTIFICATES2 from '@/assets/certificates/certificates2.jpg'
import CERTIFICATES3 from '@/assets/certificates/certificates3.jpg'
import CERTIFICATES4 from '@/assets/certificates/certificates4.jpg'
...
export default function Others2() {
    ...
    const certificates = [
        { src: CERTIFICATES1, alt: 'Certificate 1' },
        { src: CERTIFICATES2, alt: 'Certificate 2' },
        { src: CERTIFICATES3, alt: 'Certificate 3' },
    ]
                            ...
                            {certificates.map((cert, index) => (
                                <div key={index} className="w-full flex justify-center items-center">
                                    <Zoom>
                                        ...
                                        // className="rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer"
                                        />
                                    </Zoom>
                                </div>
                            ))}
