                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-time-area">
                                ...
                                <p>Your trusted partner for buying an, selling products with seamless, personalized solutions.</p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link href="#" className="d-flex align-items-center gap-2">
                                            ...
                                            Tashkent city, Yunusobod district
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="sales@emctech.uz" className="d-flex align-items-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="col-lg-12">
                        <div className="copyright-area">
                            <p>© 2025 EMC Technology, Inc. All Rights Reserved.</p>
                            <ul>
                                <li>
