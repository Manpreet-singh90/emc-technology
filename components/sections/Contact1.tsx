                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="phone-number">
                                ...
                                <div className="content">
                                    <p>Our Email</p>
                                    <Link href="mailto:Housarealesate@gmail.com">{CONFIG_CONSTANT.OFFICE_EMAIL}</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="phone-number">
                                ...
                                <div className="content">
                                    <p>Phone</p>
                                    <Link href="tel:+11234567890">{CONFIG_CONSTANT.OFFICE_CONTACT_NUMBER}</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="phone-number">
                                ...
                                <div className="content">
                                    <p>Timing</p>
                                    <Link href="tel:+11234567890">Monday-Fri: 9 AM – 6 PM</Link>
                                </div>
                            </div>
                        </div>
                    </div>
