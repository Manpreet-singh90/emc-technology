...
import { SERVICE_DETAIL } from "@/constants/service";
...
export default function BlogDetail2() {
    ...
    const FILTER_SERVICE = SERVICE_DETAIL.find(service => service.serviceId === 3);

    console.log(" ########################### ", FILTER_SERVICE)
    if (!FILTER_SERVICE) {
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="blog-post-details-area heading1">
                                            ...
                                            <React.Fragment>
                                                <div className="img1" style={{ height: '500px', maxHeight: '500px', minHeight: '500px' }} >
                                                    <Image src={FILTER_SERVICE.image} alt="banner" style={{ objectFit: "cover", height: '100%', width: "100%" }} />
                                                </div>
                                                <div className="space32" />
                                                <ul className="list-author">
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            By {FILTER_SERVICE.author} <span> | </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                ...
                                                <div className="space20" />
                                                <h2>{FILTER_SERVICE.title}</h2>
                                                <div className="space18" />
                                                {FILTER_SERVICE.content.map((paragraph, index) => (
                                                    <p key={index}>{paragraph}</p>
                                                ))}
                                                <div className="space16" />
                                                <div className="row">
                                                    {FILTER_SERVICE.images.map((image, index) => (
                                                        <div className="col-lg-6 col-md-6" key={index}>
                                                            <div className="space30" />
                                                            <div className="img1 image-anime">
                                                                <Image src={image} alt="content-image" style={{ height: '450px', maxHeight: '450px', minHeight: '450px' }} />
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
                                                ...
                                                <h3>Proven Strategies To Sell Your Home Quickly</h3>
                                                <div className="space18" />
                                                {FILTER_SERVICE.strategies.map((strategy, index) => (
                                                    <p key={index}>{strategy}</p>
                                                ))}
                                                <div className="space30" />
                                                <div className="vide-images">
                                                    <div className="img1">
                                                        <img src={FILTER_SERVICE.videoImage} alt="housa" />
                                                    </div>
                                                    {/* You can implement the VideoPopup component here */}
                                                </div>
                                                <div className="space28" />
                                                <h3>Explore Our Properties Through Virtual Tours</h3>
                                                <div className="space18" />
                                                {FILTER_SERVICE.virtualTourContent.map((tourContent, index) => (
                                                    <p key={index}>{tourContent}</p>
                                                ))}
                                                <div className="space32" />
                                            </React.Fragment>
