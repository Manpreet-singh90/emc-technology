                                                    ...
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample3">
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseEleven" className="accordion-collapse collapse show" data-bs-parent="#accordionExample3">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwelve" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirteen" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourteen" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFifteen" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample4">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtysix" aria-expanded="true" aria-controls="collapseThirtysix">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseThirtysix" className="accordion-collapse collapse" data-bs-parent="#accordionExample4">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtyseven" className="accordion-collapse collapse" data-bs-parent="#accordionExample4">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtyeight" className="accordion-collapse collapse" data-bs-parent="#accordionExample4">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtynine" className="accordion-collapse collapse" data-bs-parent="#accordionExample4">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourty" className="accordion-collapse collapse" data-bs-parent="#accordionExample4">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample5">
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseSixteen" className="accordion-collapse collapse show" data-bs-parent="#accordionExample5">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseSeventeen" className="accordion-collapse collapse" data-bs-parent="#accordionExample5">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEightteen" aria-expanded="false" aria-controls="collapseEightteen">
                                                                        How much down payment do I need to buy a home?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseEightteen" className="accordion-collapse collapse" data-bs-parent="#accordionExample5">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseNineteen" className="accordion-collapse collapse" data-bs-parent="#accordionExample5">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwenty" className="accordion-collapse collapse" data-bs-parent="#accordionExample5">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample6">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyone" aria-expanded="true" aria-controls="collapseFourtyone">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseFourtyone" className="accordion-collapse collapse" data-bs-parent="#accordionExample6">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtytwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample6">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtythree" className="accordion-collapse collapse" data-bs-parent="#accordionExample6">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtyfour" className="accordion-collapse collapse" data-bs-parent="#accordionExample6">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtyfive" className="accordion-collapse collapse" data-bs-parent="#accordionExample6">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample7">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentyone" aria-expanded="true" aria-controls="collapseTwentyone">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseTwentyone" className="accordion-collapse collapse show" data-bs-parent="#accordionExample7">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentytwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample7">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentythree" className="accordion-collapse collapse" data-bs-parent="#accordionExample7">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentyfour" className="accordion-collapse collapse" data-bs-parent="#accordionExample7">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentyfive" className="accordion-collapse collapse" data-bs-parent="#accordionExample7">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample8">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtySix" aria-expanded="true" aria-controls="collapseFourtySix">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseFourtySix" className="accordion-collapse collapse" data-bs-parent="#accordionExample8">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtySeven" aria-expanded="false" aria-controls="collapseFourtySeven">
                                                                        How do I calculate my on investment (ROI) real estate?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseFourtySeven" className="accordion-collapse collapse" data-bs-parent="#accordionExample8">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtyEight" className="accordion-collapse collapse" data-bs-parent="#accordionExample8">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseFourtyNine" className="accordion-collapse collapse" data-bs-parent="#accordionExample8">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyTen" aria-expanded="false" aria-controls="collapseFourtyTen">
                                                                        Do I have to pay taxes when selling my home?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseFourtyTen" className="accordion-collapse collapse" data-bs-parent="#accordionExample8">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample9">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentysix" aria-expanded="true" aria-controls="collapseTwentysix">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseTwentysix" className="accordion-collapse collapse show" data-bs-parent="#accordionExample9">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentyseven" className="accordion-collapse collapse" data-bs-parent="#accordionExample9">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentyeight" className="accordion-collapse collapse" data-bs-parent="#accordionExample9">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseTwentynine" className="accordion-collapse collapse" data-bs-parent="#accordionExample9">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirty" className="accordion-collapse collapse" data-bs-parent="#accordionExample9">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample10">
                                                            <div className="accordion-item">
                                                                <h2 className="accordion-header">
                                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtyone" aria-expanded="true" aria-controls="collapseThirtyone">
                                                                        Do I need a real estate agent to buy or sell a property?
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseThirtyone" className="accordion-collapse collapse" data-bs-parent="#accordionExample10">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtytwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample10">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtythree" className="accordion-collapse collapse" data-bs-parent="#accordionExample10">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtyfour" className="accordion-collapse collapse" data-bs-parent="#accordionExample10">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapseThirtyfive" className="accordion-collapse collapse" data-bs-parent="#accordionExample10">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample11">
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse1" className="accordion-collapse collapse show" data-bs-parent="#accordionExample11">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse2" className="accordion-collapse collapse" data-bs-parent="#accordionExample11">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse3" className="accordion-collapse collapse" data-bs-parent="#accordionExample11">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse4" className="accordion-collapse collapse" data-bs-parent="#accordionExample11">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse5" className="accordion-collapse collapse" data-bs-parent="#accordionExample11">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="accordian-area">
                                                        <div className="accordion" id="accordionExample12">
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse6" className="accordion-collapse collapse" data-bs-parent="#accordionExample12">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse7" className="accordion-collapse collapse" data-bs-parent="#accordionExample12">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse8" className="accordion-collapse collapse" data-bs-parent="#accordionExample12">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse9" className="accordion-collapse collapse" data-bs-parent="#accordionExample12">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="accordion-item">
                                                                ...
                                                                <div id="collapse10" className="accordion-collapse collapse" data-bs-parent="#accordionExample12">
                                                                    <div className="accordion-body">
                                                                        <p>Navigating the real estate market can been overwhelming, whether you're buying your first home, selling property, or investing in real estate. Housa, we understand that every decision involves crucial details, from financing.</p>
                                                                    </div>
                                                                </div>
