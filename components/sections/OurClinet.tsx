                        ...
                        <div className="col-lg-7 m-auto">
                            <div className="heading2 text-center space-margin60">
                                <h5>
                                    ...
                                    {CONTENT.CLIENT_WHO_TRUST_US.HEADING}
                                </h5>
                                <div className="space18" />
                                <h2>{CONTENT.CLIENT_WHO_TRUST_US.SUBHEADING}</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <Swiper
                                ...
                                loop={true}
                            >
                                {CONTENT.CLIENT_WHO_TRUST_US.IMAGES.map((src, idx) => (
                                    <SwiperSlide key={idx} className="small-img">
                                        <img src={src} alt={`client-logo-${idx + 1}`} />
                                    </SwiperSlide>
                                ))}
                            </Swiper>
